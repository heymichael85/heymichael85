...
.NOTES
    ...
    Documentation   : https://stigaview.com/products/win11/v2r7/WN11-CC-000115/
...
# Create or update the DevicePKInitEnabled DWORD value
...
Write-Host "DevicePKInitEnabled has been set to 1."

# Verify the setting
Get-ItemProperty -Path $RegistryPath -Name 'DevicePKInitEnabled'
